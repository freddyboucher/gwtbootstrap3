...
public enum Language {
  ...
  Basque("eu", FullCalendarClientBundle.INSTANCE.getBasque()),
  ...
  EnglishIreland("en-ie", FullCalendarClientBundle.INSTANCE.getEnglishIreland()),
  EnglishNewZealand("en-nz", FullCalendarClientBundle.INSTANCE.getEnglishNewZealand()),
  ...
  FrenchSwitzerland("fr-ch", FullCalendarClientBundle.INSTANCE.getFrenchSwitzerland()),
  French("fr", FullCalendarClientBundle.INSTANCE.getFrench()),
  Galician("gl", FullCalendarClientBundle.INSTANCE.getGalician()),
  Hebrew("he", FullCalendarClientBundle.INSTANCE.getHebrew()),
  ...
  Luxembourgish("lb", FullCalendarClientBundle.INSTANCE.getLuxembourgish()),
  ...
  Norwegian("nn", FullCalendarClientBundle.INSTANCE.getNorwegian()),
  ...
  Language(String code, TextResource resource) {
    this.code = code;
