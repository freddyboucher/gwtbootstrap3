...
public class DragAndResizeConfig implements IsJavaScriptObject {
  ...
  private native void newInstance(DragAndResizeCallback handler) /*-{
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.DragAndResizeConfig::script.eventDragStart = function (event, jsEvent,
                                                                                                                        ui, view) {
      if (event && jsEvent) {
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.DragAndResizeConfig::script.eventDragStop = function (event, jsEvent,
                                                                                                                       ui, view) {
      if (event && jsEvent) {
        var originalEvent = null;
        if (jsEvent.originalEvent) {
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.DragAndResizeConfig::script.eventDrop = function (event, delta,
                                                                                                                   revertFunc, jsEvent,
                                                                                                                   ui, view) {
      var originalEvent = null;
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.DragAndResizeConfig::script.eventResizeStart = function (event, jsEvent,
                                                                                                                          ui, view) {
      if (event && jsEvent) {
        var originalEvent = null;
        if (jsEvent.originalEvent) {
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.DragAndResizeConfig::script.eventResizeStop = function (event, jsEvent,
                                                                                                                         ui, view) {
      if (event && jsEvent) {
        var originalEvent = null;
        if (jsEvent.originalEvent) {
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.DragAndResizeConfig::script.eventResize = function (event, delta,
                                                                                                                     revertFunc, jsEvent,
                                                                                                                     ui, view) {
      var originalEvent = null;
      if (jsEvent && jsEvent.originalEvent) {
