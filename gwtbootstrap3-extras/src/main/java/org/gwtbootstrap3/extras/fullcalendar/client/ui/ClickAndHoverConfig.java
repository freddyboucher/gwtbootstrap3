...
public class ClickAndHoverConfig implements IsJavaScriptObject {
  ...
  private native void newInstance(ClickAndHoverEventCallback handler) /*-{
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.ClickAndHoverConfig::script.eventClick = function (calEvent, jsEvent,
                                                                                                                    view) {
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.ClickAndHoverConfig::script.eventMouseover = function (calEvent,
                                                                                                                        jsEvent, view) {
    ...
    theInstance.@org.gwtbootstrap3.extras.fullcalendar.client.ui.ClickAndHoverConfig::script.eventMouseout = function (calEvent, jsEvent,
                                                                                                                       view) {
