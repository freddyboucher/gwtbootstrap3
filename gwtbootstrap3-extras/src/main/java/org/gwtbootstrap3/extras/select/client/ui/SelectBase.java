...
import static org.gwtbootstrap3.extras.select.client.ui.SelectOptions.STYLE_BASE;
 ...
 */
public abstract class SelectBase<T> extends ComplexWidget
    implements HasValue<T>, HasEnabled, Focusable, HasType<ButtonType>, HasSize<ButtonSize>, IsEditor<LeafValueEditor<T>>,
