 ...
 */
public class FormsWithValidationPresenter extends Presenter<FormsWithValidationPresenter.MyView, FormsWithValidationPresenter.MyProxy> {
  ...
  @Inject
  public FormsWithValidationPresenter(EventBus eventBus, MyView view, MyProxy proxy) {
