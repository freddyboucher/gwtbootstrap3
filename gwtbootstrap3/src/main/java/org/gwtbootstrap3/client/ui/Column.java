...
public class Column extends Div {
  ...
  private <E extends Enum<? extends Style.HasCssName>> void addEnumVarargsValues(E[] values, Class<E> enumClass, boolean clearOld) {
    if (clearOld) {
  ...
  private <E extends Enum<? extends Style.HasCssName>> void addEnumStringValues(String values, Class<E> enumClass, boolean clearOld) {
    if (clearOld) {
      // Remove the previous values
      removeStyleNames(enumClass);
    }
